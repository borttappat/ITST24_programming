### This is a take on sol to minimize the use of loops and if clauses
### Part of code is written with AI Assist
### Necessary ifs and loops are now only as method built-ins
